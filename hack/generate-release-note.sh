...
help() {
  ...
  echo "  release: The release version, e.g. v1.21.0"
  echo "  output: The output file, default to release-notes.md"
  echo "  GITHUB_TOKEN: The GitHub token to access the GitHub API (required environment variable)"
}
